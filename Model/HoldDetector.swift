...
class HoldDetectorInput : MLFeatureProvider {
...
@available(macOS 10.14, iOS 12.0, tvOS 12.0, watchOS 5.0, visionOS 1.0, *)
class HoldDetectorOutput : MLFeatureProvider {
...
class HoldDetector {
    ...
    class var urlOfModelInThisBundle : URL {
        ...
        return bundle.url(forResource: "HoldDetector", withExtension:"mlmodelc")!
    }

    /**
        Construct HoldDetector instance with an existing MLModel object.

        Usually the application does not use this initializer unless it makes a subclass of HoldDetector.
        Such application may want to use `MLModel(contentsOfURL:configuration:)` and `HoldDetector.urlOfModelInThisBundle` to create a MLModel object to pass-in.
    ...
    */
    ...
    /**
        Construct HoldDetector instance by automatically loading the model from the app's bundle.
    */
    ...
    */
    ...
    /**
        Construct HoldDetector instance with explicit path to mlmodelc file
        - parameters:
    ...
    */
    ...
    /**
        Construct HoldDetector instance asynchronously with optional configuration.
    ...
    */
    ...
    class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<HoldDetector, Error>) -> Void) {
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> HoldDetector {
        try await load(contentsOf: self.urlOfModelInThisBundle, configuration: configuration)
    }

    /**
        Construct HoldDetector instance asynchronously with URL of the .mlmodelc directory with optional configuration.
    ...
    */
    @available(macOS 11.0, iOS 14.0, tvOS 14.0, watchOS 7.0, visionOS 1.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<HoldDetector, Error>) -> Void) {
        MLModel.load(contentsOf: modelURL, configuration: configuration) { result in
            switch result {
            case .failure(let error):
                handler(.failure(error))
            case .success(let model):
                handler(.success(HoldDetector(model: model)))
            }
        }
    }
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> HoldDetector {
        let model = try await MLModel.load(contentsOf: modelURL, configuration: configuration)
        return HoldDetector(model: model)
    }
    ...
    /**
        ...
        - parameters:
           - input: the input to the prediction as HoldDetectorInput

        - throws: an NSError object that describes the problem

        - returns: the result of the prediction as HoldDetectorOutput
    */
    func prediction(input: HoldDetectorInput) throws -> HoldDetectorOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as HoldDetectorOutput
    */
    func prediction(input: HoldDetectorInput, options: MLPredictionOptions) throws -> HoldDetectorOutput {
        let outFeatures = try model.prediction(from: input, options: options)
        return HoldDetectorOutput(features: outFeatures)
    }
    ...
    */
    ...
    func prediction(input: HoldDetectorInput, options: MLPredictionOptions = MLPredictionOptions()) async throws -> HoldDetectorOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as HoldDetectorOutput
    */
    func prediction(imagePath: CVPixelBuffer, iouThreshold: Double?, confidenceThreshold: Double?) throws -> HoldDetectorOutput {
        let input_ = HoldDetectorInput(imagePath: imagePath, iouThreshold: iouThreshold, confidenceThreshold: confidenceThreshold)
    ...
    /**
        ...
        - parameters:
           - inputs: the inputs to the prediction as [HoldDetectorInput]
           - options: prediction options
        ...
        - returns: the result of the prediction as [HoldDetectorOutput]
    */
    func predictions(inputs: [HoldDetectorInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [HoldDetectorOutput] {
        let batchIn = MLArrayBatchProvider(array: inputs)
        let batchOut = try model.predictions(from: batchIn, options: options)
        var results : [HoldDetectorOutput] = []
        results.reserveCapacity(inputs.count)
        for i in 0..<batchOut.count {
            let outProvider = batchOut.features(at: i)
            let result =  HoldDetectorOutput(features: outProvider)
