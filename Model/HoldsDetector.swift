...
class HoldsDetectorInput : MLFeatureProvider {
...
@available(macOS 11.0, iOS 14.0, tvOS 14.0, visionOS 1.0, *)
@available(watchOS, unavailable)
class HoldsDetectorOutput : MLFeatureProvider {
...
class HoldsDetector {
    ...
    class var urlOfModelInThisBundle : URL {
        ...
        return bundle.url(forResource: "HoldsDetector", withExtension:"mlmodelc")!
    }

    /**
        Construct HoldsDetector instance with an existing MLModel object.

        Usually the application does not use this initializer unless it makes a subclass of HoldsDetector.
        Such application may want to use `MLModel(contentsOfURL:configuration:)` and `HoldsDetector.urlOfModelInThisBundle` to create a MLModel object to pass-in.
    ...
    */
    ...
    /**
        Construct HoldsDetector instance with explicit path to mlmodelc file
        - parameters:
    ...
    */
    ...
    /**
        Construct HoldsDetector instance asynchronously with optional configuration.
    ...
    */
    class func load(configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<HoldsDetector, Error>) -> Void) {
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    class func load(configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> HoldsDetector {
        try await load(contentsOf: self.urlOfModelInThisBundle, configuration: configuration)
    }

    /**
        Construct HoldsDetector instance asynchronously with URL of the .mlmodelc directory with optional configuration.
        ...
        - parameters:
          ...
          - handler: the completion handler to be called when the model loading completes successfully or unsuccessfully
    */
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration(), completionHandler handler: @escaping (Swift.Result<HoldsDetector, Error>) -> Void) {
        MLModel.load(contentsOf: modelURL, configuration: configuration) { result in
            switch result {
            case .failure(let error):
                handler(.failure(error))
            case .success(let model):
                handler(.success(HoldsDetector(model: model)))
            }
        }
    }
    ...
    */
    @available(macOS 12.0, iOS 15.0, tvOS 15.0, watchOS 8.0, visionOS 1.0, *)
    class func load(contentsOf modelURL: URL, configuration: MLModelConfiguration = MLModelConfiguration()) async throws -> HoldsDetector {
        let model = try await MLModel.load(contentsOf: modelURL, configuration: configuration)
        return HoldsDetector(model: model)
    }
    ...
    /**
        ...
        - parameters:
           - input: the input to the prediction as HoldsDetectorInput

        - throws: an NSError object that describes the problem

        - returns: the result of the prediction as HoldsDetectorOutput
    */
    func prediction(input: HoldsDetectorInput) throws -> HoldsDetectorOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as HoldsDetectorOutput
    */
    func prediction(input: HoldsDetectorInput, options: MLPredictionOptions) throws -> HoldsDetectorOutput {
        let outFeatures = try model.prediction(from: input, options: options)
        return HoldsDetectorOutput(features: outFeatures)
    }
    ...
    */
    ...
    func prediction(input: HoldsDetectorInput, options: MLPredictionOptions = MLPredictionOptions()) async throws -> HoldsDetectorOutput {
    ...
    /**
        ...
        - returns: the result of the prediction as HoldsDetectorOutput
    */
    func prediction(image: CVPixelBuffer, iouThreshold: Double?, confidenceThreshold: Double?) throws -> HoldsDetectorOutput {
        let input_ = HoldsDetectorInput(image: image, iouThreshold: iouThreshold, confidenceThreshold: confidenceThreshold)
    ...
    /**
        ...
        - parameters:
           - inputs: the inputs to the prediction as [HoldsDetectorInput]
           - options: prediction options
        ...
        - returns: the result of the prediction as [HoldsDetectorOutput]
    */
    func predictions(inputs: [HoldsDetectorInput], options: MLPredictionOptions = MLPredictionOptions()) throws -> [HoldsDetectorOutput] {
        let batchIn = MLArrayBatchProvider(array: inputs)
        let batchOut = try model.predictions(from: batchIn, options: options)
        var results : [HoldsDetectorOutput] = []
        results.reserveCapacity(inputs.count)
        for i in 0..<batchOut.count {
            let outProvider = batchOut.features(at: i)
            let result =  HoldsDetectorOutput(features: outProvider)
